...
public class WLTwitterDatabaseProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        return this.databaseHelper.getReadableDatabase().query(WLTwitterDatabaseContract.TABLE_TWEETS, projection, selection, selectionArgs, sortOrder, null, null);
    }
    ...
    public Uri insert(Uri arg0, ContentValues arg1) {
        ...
        this.databaseHelper.getReadableDatabase().insert(WLTwitterDatabaseContract.TABLE_TWEETS, null, arg1);
        return arg0;
    }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        return this.databaseHelper.getReadableDatabase().delete(WLTwitterDatabaseContract.TABLE_TWEETS, selection, selectionArgs);
    }

    @Override
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        Log.d(Constants.General.LOG_TAG, "UPDATE");
        return this.databaseHelper.getReadableDatabase().update(WLTwitterDatabaseContract.TABLE_TWEETS, values, selection, selectionArgs);
    }
}
